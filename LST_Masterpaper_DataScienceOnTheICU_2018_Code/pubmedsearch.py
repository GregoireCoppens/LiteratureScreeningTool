...
import settings
retmax = 9999
searchterm = '("Medical Informatics"[Mesh] OR "Algorithms"[Mesh] OR "Data Collection"[Mesh:NoExp] OR "Automatic Data Processing"[Mesh]) AND ("Intensive Care Units"[Mesh] or "Critical Care"[Mesh]) '
...
def search(query):
    ...
    handle = Entrez.esearch(db='pubmed',  # database
                            ...
                            maxdate='2018/12/31')    # maximum date
